(function(global, factory) {
  ...
  _M.prototype.note = function(c, n, v, t) {//alert(88);
    this.noteOn(c, n, v);
  ...
  var _helperMPE = {
    ...
    noteOn: function(c, n, v) {//alert(88) ;
    if (typeof v == 'undefined') v = 127; return [0x90 + _ch(c), _7bn(n), _7b(v)]; },
  ...
  MIDI.prototype.getNote = function() {//alert(88);
    var c = this[0];
  ...
  MIDI.prototype.isNoteOn = function() {//alert(88);
    var c = this[0];
  ...
  var _helperGC = {
    umpNoteOn: function(g, c, n, v, t, a) {//alert(121);
  ...
  UMP.prototype.isNoteOn = function() {//alert(121);
    var c = (this[0] || 0) >> 4;
    var d = (this[1] || 0) >> 4;
    if (c == 4) return d == 9;
